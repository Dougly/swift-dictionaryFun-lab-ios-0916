...
var favoriteFlavorsOfIcCream = ["Joe" : "Peanut Butter and Chocolate",
                                "Tim" : "Natural Vanilla",
                                "Sophie" : "Mexican Chocolate",
                                "Deniz" : "Natural Vanilla",
                                "Tom" : "Mexican Chocolate",
...
func namesForIceCreamFlavor(flavor: String) -> [String] {
    var names: [String] = []
    for (person, favorite) in favoriteFlavorsOfIcCream {
        if favorite == flavor {
            names.append(person)
        }
    }
...
func countForIceCreamFlavor(flavor: String) -> Int {
    var num = 0
    for favorite in favoriteFlavorsOfIcCream.values {
        if  favorite == flavor {
            num += 1
        }
    }
...
func iceCreamForPerson(name: String) -> String? {
    if favoriteFlavorsOfIcCream[name] != nil {
        return favoriteFlavorsOfIcCream[name]
    } else {
        return nil
    }
}
...
func replaceFlavor(flavor: String, forPerson person: String) -> Bool {
    if favoriteFlavorsOfIcCream[person] != nil {
        if favoriteFlavorsOfIcCream[person] == flavor {
            return false
        } else {
            favoriteFlavorsOfIcCream.updateValue(flavor, forKey: person)
            return true
        }
    } else {
        return false
...
func removePerson(name: String) -> Bool {
    if favoriteFlavorsOfIcCream[name] != nil {
        favoriteFlavorsOfIcCream[name] = nil
        return true
    } else {
        return false
    }
...
func numberOfAttendees() -> Int {
    return favoriteFlavorsOfIcCream.count
}
...
func addPerson(name: String, withFlavor flavor: String) -> Bool {
    if favoriteFlavorsOfIcCream[name] == nil {
        favoriteFlavorsOfIcCream[name] = flavor
        return true
    } else {
        return false
    }
